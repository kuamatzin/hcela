...
<div class="form-group{{ $errors->has('machine_type') ? ' has-error' : '' }}">
    ...
    {!! Form::select('machine_type',[1 => 'Mandril', 2 => 'Trompo', 3 => 'Tornillo de Banco', 4 => 'Escuadradora', 5 => 'Sierra Circular', 6 => 'Trompo Herramienta', 7 => 'Lijadora de Banda', 8 => 'Torno', 9 => 'Escoplo', 10 => 'Sierra Cinta', 11 => 'Husillo', 12 => 'Sargento'], $machine->getOriginal('machine_type'), ['id' => 'machine_type', 'class' => 'form-control', 'required' => '']) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group{{ $errors->has('especificaciones_tres[]') ? ' has-error' : '' }}">
                            {!! Form::text('especificaciones_tres[]', null, ['class' => 'form-control', 'placeholder' => 'Opcional', 'v-model' => 'categoria.especificaciones_t[$index]']) !!}
